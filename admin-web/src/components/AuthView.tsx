...
export function AuthView({ onAuthenticated }: { onAuthenticated: () => Promise<void> | void }) {
  ...
  return <main className="auth-shell"><div className="auth-glow auth-glow-one" /><div className="auth-glow auth-glow-two" />
    ...
    </div><footer className="auth-footer"><span>Cloud-Campus Admin</span><span>Connected build / v0.2</span></footer></section>
  </main>;
}
