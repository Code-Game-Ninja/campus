...
export default function Tribe() {
  ...
  return <Screen>
    ...
    {tab === 'Find people' ? <>
      ...
      <View style={{ marginTop: 14 }}><SearchField value={query} onChangeText={setQuery} placeholder="Search anyone by name, username, or email" /></View>
